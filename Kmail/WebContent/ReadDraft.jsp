...
<form name="draft" method="post">
<input type="hidden" name="msgId" value="<%=request.getParameter("msgId") %>" />
<input type="hidden" name="page1" value="draft" />
</form>
...
String message="",msgDateTime="",fileName="",toHeader="",ccHeader="",bccHeader="";
	...
	{
		showMessage1.displayDraft(Integer.parseInt(request.getParameter("msgId")),(String)session.getAttribute("userId"));
...
function draft() 
    {
        ...
        document.draft.action="compose.jsp";
       	...
       	<table width="100%" align="center" bgcolor="#FFFFFF" bordercolor="#0000FF">
                    ...
                    %>   
        					...
        					<tr>
                                ...
                                <td>
                                	<a href="javascript:draft();">Compose Mail</a>
                                </td>
